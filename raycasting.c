	...
	int player_y, double player_angle, Map map)
{
	...
	for (int i = 0; i < NUM_RAYS; i++)
	{
        ...
        int wall_height = (int)(SCREEN_H / distance_to_wall);
        int wall_start = (SCREEN_H / 2) - (wall_height / 2);
        int wall_end = (SCREEN_H / 2) + (wall_height / 2);
        ...
        SDL_RenderDrawLine(renderer, i, wall_end, i, SCREEN_H);
	}
}
